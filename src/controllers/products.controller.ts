...
function mapProduct(row: Record<string, unknown>) {
  ...
  return {
    ...
    // priceFor/compareAtPriceFor are the identity in production; in staging they
    // collapse to the flat STAGING_PRICE_OVERRIDE_INR so the storefront shows the
    // same ₹1 the cart resolver will charge.
